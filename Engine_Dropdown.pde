...
class Engine_Dropdown extends Engine_Button {
  ...
  public Engine_Dropdown(int X, int Y, int Width, int Height, String Text, String[] Options) {
    // Super it.
    ...
    if (Options == null)
     ...
     for (int i = 0; i < Options.length; i++)
       OptionButtons[i] = new Engine_Button(X, Y + Height * (i + 1), Width, Height, Options[i]);
  }
